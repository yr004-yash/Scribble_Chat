                ...
                {usernm === localStorage.getItem('name') && (
                    ...
                    >
                        <Button
                            ...
                            style={buttonStyle(selectedTool, 'pencil')}
                        >
                            <img src={pencilbg} style={imageStyle} />
                        </Button>
                        <Button
                            variant="contained"
                            onClick={() => setSelectedTool('rectangle')}
                            style={buttonStyle(selectedTool, 'rectangle')}
                        >
                            <img src={rect} style={imageStyle} />
                        </Button>
                        <Button
                            variant="contained"
                        ...
                        >
                            <img src={cir} style={imageStyle} />
                        </Button>
                        <Button variant="contained" onClick={clearCanvas} style={buttonStyle()}>
                            <img src={clearcanva} style={imageStyle} />
                        </Button>
                    </div>
                )}
            </div>
...
const buttonStyle = (selectedTool, toolName) => ({
    height: '80%',
    width: '20%',
    background: `linear-gradient(45deg, #2175F3, #21AAF3)`,
    backgroundSize: 'cover',
    ...
    boxShadow: 'inset 0 0 20px rgba(0, 0, 255, 0.6)',
    transition: 'background 0.3s, transform 0.3s',
    transform: selectedTool === toolName ? 'scale(0.8)' : 'scale(1)',
    fontSize: '80%',
    fontStretch: 'condensed',
    margin: '1%',
});

const imageStyle = { height: '100%', width: 'auto', marginRight: '1px' };
